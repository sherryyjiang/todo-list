    ...
    server.setRequestHandler(ListToolsRequestSchema, async () => {
        return {
            tools: [
                {
                    name: "list_tasks",
                    description: "List all tasks in the todo list, grouped by their status (today, tomorrow, this_week, next_week, backlog). Use this to show the user their current tasks.",
                    inputSchema: {
                        type: "object",
                        properties: {
                            status: {
                ...
                {
                    name: "add_task",
                    description: "Add a new task to the todo list. Tasks are automatically added to the backlog. Use this when the user wants to create a new task or reminder.",
                    inputSchema: {
                        type: "object",
                        properties: {
                            title: {
                ...
                {
                    name: "complete_task",
                    description: "Mark a task as complete or incomplete (toggles the completion status). Use this when the user says they finished a task.",
                    inputSchema: {
                        type: "object",
                        properties: {
                            task_id: {
                ...
                {
                    name: "move_task",
                    description: "Move a task to a different time bucket (today, tomorrow, this_week, next_week, or backlog). Use this to reschedule or prioritize tasks.",
                    inputSchema: {
                        type: "object",
                        properties: {
                            task_id: {
                ...
                {
                    name: "delete_task",
                    description: "Delete a task from the todo list. Use this when the user wants to remove a task entirely.",
                    inputSchema: {
                        type: "object",
                        properties: {
                            task_id: {
        ...
        try {
            switch (name) {
                case "list_tasks": {
                    ...
                    if (typedArgs?.status) {
                        filteredTasks = tasks.filter((t) => t.status === typedArgs.status);
                    }
